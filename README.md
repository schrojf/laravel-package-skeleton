...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/package-name.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/package-name)
...
```php
$packageName = new Vendor\PackageName();
echo $packageName->echoPhrase('Hello, Vendor!');
```
...
- [Forename Surname](https://github.com/username)
